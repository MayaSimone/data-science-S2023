...
- Is Michelson's estimate of the error (his uncertainty) greater or less than the true error?
  - Less than (magnitude of about 100 vs 151)
- Make a quantitative comparison between Michelson's uncertainty and his error.
  - Michelson's was able to find some areas of potential errors, but since it is lower than actual error, he might not have considered/found them all
...
- It's hard to find specific trends related to level of distinctness because there aren't many measurements in the '1' category, and the level of distinctness seems to be determined by the day

- It seems like higher temperatures can be related to the higher velocity measurements
