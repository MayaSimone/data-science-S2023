...
**Observations**:
- The values for `cases_per100k` and `deaths_per100k` for the top 10 counties in each category are significantly higher than the mean values (about 6X and about 7X greater, respectively)
  - This variation is also demonstrated by the fairly high S.D. values (roughly the same at the mean)
- The highest `cases_per100k` (Loving, Texas) is significantly greater than the mean value (over 19X greater)
