...
- Generally, as the carat of a diamond increases, so to does its price. They show a positive correlation.
...
- There seems to be minimal differences in price between the 'ideal', 'premium', and 'very good' cut diamonds, best shown by the second graph

- The 'fair' diamonds tend to have a lower price compared to diamonds of the same carat.
