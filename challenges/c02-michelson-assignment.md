...
uncertainty) greater or less than the true error? - Less than (magnitude
of about 100 vs 151) - Make a quantitative comparison between
Michelson’s uncertainty and his error. - Michelson’s was able to find
some areas of potential errors, but since it is lower than actual error,
he might not have considered/found them all
...
```
    ...
    ##    Date                    n
    ##    <dttm>              <int>
    ##  1 1879-07-02 00:00:00     4
    ##  2 1879-07-01 00:00:00     4
    ##  3 1879-06-30 00:00:00     4
    ##  4 1879-06-27 00:00:00     6
    ##  5 1879-06-26 00:00:00     2
    ##  6 1879-06-24 00:00:00     5
    ##  7 1879-06-23 00:00:00     5
    ##  8 1879-06-21 00:00:00    10
    ##  9 1879-06-20 00:00:00    10
    ## 10 1879-06-18 00:00:00     6
    ## 11 1879-06-17 00:00:00     8
    ## 12 1879-06-14 00:00:00    10
    ## 13 1879-06-13 00:00:00    10
    ## 14 1879-06-12 00:00:00     3
    ## 15 1879-06-10 00:00:00     2
    ## 16 1879-06-09 00:00:00     5
    ## 17 1879-06-07 00:00:00     5
    ## 18 1879-06-05 00:00:00     1

**Observations**: Similarities - The mean measurements for each day seem
to generally stay within the plus/minus bounds of Michelson’s
estimates. - The general trend of the two mean lines seem to match up.
Michelson’s data shows higher mean velocity ‘peaks’ on the same days the
simulation does. - The region from June 14 to June 20 is when the mean
lines from the two graphs are the most similar - The simulation seems to
have generated the same number of values as measurements Michelson
recorded on each day (i.e. There are 5 data points on each graph for
June 9th)

Differences - Michelson’s data seems to have more extreme outliers than
the simulated data - The simulated data seems to cluster near the true
speed of light more than Michelson’s data during the first half of the
experiment (before June 18th) - The mean values that fell outside of the
plus/minus bounds occurred earlier on in the Michelson data (June
9-13th), but later in the simulated data (June 26th and 30th)
...
df_q2 %>%
  ...
  scale_color_gradient2(
    midpoint=mid, low="purple", mid="blue",high="red", space ="Lab"
  ) +
...
- It’s hard to find specific trends related to level of distinctness
  because there aren’t many measurements in the ‘1’ category, and the
  level of distinctness seems to be determined by the day

- It seems like higher temperatures can be related to the higher
