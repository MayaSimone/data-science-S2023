...
### __q3__ Using `ggplot`, visualize `price` vs `carat` with points. What trend do you observe?
...
### __q4__ Create a new graph to visualize `price`, `carat`, and `cut` simultaneously.
...
- There seems to be minimal differences in cost between the 'ideal', 'premium', and 'very good' cut diamonds, but the 'fair' diamonds tend to have a lower price compared to diamonds of the same carat.
