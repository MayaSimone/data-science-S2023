...
- Carat: ~0.7-0.79 is common, with a fairly large variation (0.2-5.01)
- Cut: Ideal is common, being about 40% of the dataset. Less variation since most diamonds in the set are Very Good to Ideal (~87%)
- Color: G is most common, but the dataset is quite varied with the more average colors are more common and the best/worst are rarer
