...
practicing data scientist. Unfortunately, much like human-centered design, EDA is hard to teach. This is because EDA is **not** a strict procedure, so much as it is a **mindset**. Also, much like human-centered design, EDA is an *iterative, nonlinear process*. There are two key principles to keep in mind when doing EDA:
...
### __q0__ Remember from `e02-data-basics` there were *simple checks* we're supposed to do? Do those simple checks on the diamonds dataset below.
...
### __q1__ Run the chunk below, and study the plot. Was hypothesis 1 correct? Why or why not?
...
**Observations**:
- The hypothesis was incorrect as the ideal cut diamonds are actually the most common
...
**Observations**:
- It's hard to make any definite conclusions about cost here since there is significant overplotting
...
**Observations**:
- Ideal diamonds seem to be less expensive than the other cuts
...
**Observations**:
- The median carat of the 'Ideal' cut diamonds is lower than the other cuts, while the 'Fair' cut diamonds have the highest median carat. This makes sense as carat is based on the weight on the diamond, and cutting a diamond more would reduce it's weight
